...
╚═╝  ╚═╝ ╚═╝     ╚═╝ ╚═╝  ╚═╝ ╚═╝  ╚═╝  ╚═════╝    										
	...
	fmt.Println(`Git : @xwet Telegram : @AimFov `)
	fmt.Println(` `)

	var phone string
	fmt.Println("\033[01;31m[\033[01;37m+\033[01;31m]\033[01;37mTool :\033[01;31m SMS and Call spammer")
	
	fmt.Print("\033[01;31m[\033[01;37m+\033[01;31m] \033[01;37mEnter your \033[00;31m target\033[00;37m Number : \033[00;31m")
	fmt.Scan(&phone)
	...
	for i := 0; i < repeatCount*183; i++ {
		...
		if statusCode == 404 || statusCode == 400 {
			...
			fmt.Println("\033[01;31m[\033[01;37m+\033[01;31m] \033[02;37mSended")
		}
