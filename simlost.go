...
/*
Channel telegram : @AimFov 

Link Github : https://github.com/XWET

Powerful sms - call spammer : simlost
*/
func clearScreen() {
...
╚═╝  ╚═╝ ╚═╝     ╚═╝ ╚═╝  ╚═╝ ╚═╝  ╚═╝  ╚═════╝    										
	`)
	fmt.Println("\033[00;31m")
	fmt.Println("\033[01;37m Git : \033[00;31m@xwet \033[01;37mTelegram :\033[00;31m @AimFov ")
	fmt.Println(` `)

	var phone string
	fmt.Println("\033[01;31m[\033[01;37m+\033[01;31m]\033[01;37m Tool :\033[00;31m SMS and Call spammer")

	fmt.Print("\033[01;31m[\033[01;37m+\033[01;31m] \033[01;37mEnter your target Number : \033[00;31m")
	fmt.Scan(&phone)

	var repeatCount int
	fmt.Print("\033[01;31m[\033[01;37m+\033[01;31m] \033[01;37mEnter number of call and sms : \033[00;31m")
	...
	for i := 0; i < repeatCount*183; i++ {
		...
		if statusCode == 404 || statusCode == 400 {
			...
			fmt.Println("\033[01;31m[\033[01;32m+\033[01;31m] \033[02;37mSended")
		}
